<?php 
 ...
 // echo "<script>alert('".$_SESSION['userType']."');</script>";
  if(!isset($_SESSION['userType']) || $_SESSION['userType'] != 'G001_001') {
    echo "<meta http-equiv='refresh' content='0;url=".$siteLink."management/admin_login.php'>";
    exit;
  }
...
<head>
  ...
  <title>Yes Acupuncture Clinic Management</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=$siteLink?>management/booking_list.php">
        <div class="sidebar-brand-icon rotate-n-15">
          <!-- <i class="fas fa-laugh-wink"></i> -->
          <img src="<?=$siteLink?>img/yes_simbol.png" style="width: 45px;" />
        </div>
        <div class="sidebar-brand-text mx-3">Yes Acupuncture Clinic</div>
      </a>
      ...
      <li class="nav-item" id="navBooking">
        <a class="nav-link" href="<?=$siteLink?>management/booking_list.php">
      ...
      <li class="nav-item" id="navService">
        <a class="nav-link" href="<?=$siteLink?>management/service.php">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
            ...
            <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100">
              <a href="<?=$siteLink?>index.php" target="_blank">
